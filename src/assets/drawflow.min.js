      ...
      class i {
        ...
        click(e) {
          if ((this.dispatch("click", e), "fixed" === this.editor_mode)) {
            ...
            "view" === this.editor_mode
              ? (null != e.target.closest(".drawflow") ||
        ...
        position(e) {
          ...
          if (this.drag_point) {
            ...
            this.drawflow.drawflow[this.module].data[h].outputs[d].connections[
              u
            ].points[r] = { pos_x: o, pos_y: l };
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                if (
                  0 ===
                  Object.keys(this.getNodeFromId(s.slice(5)).inputs).length
                )
                  var o = !1;
                else var o = "input_1";
              }
              ...
              if (l !== s && !1 !== o) {
                if (
                  ...
                  this.drawflow.drawflow[this.module].data[a].outputs[
                    c
                  ].connections.push({ node: d, output: o }),
                    this.drawflow.drawflow[this.module].data[d].inputs[
                      o
                    ].connections.push({ node: a, input: c }),
          ...
          Object.keys(f).map(function (t, n) {
            if (null === f[t].querySelector(".point")) {
              var g = i.querySelector("#" + e),
                ...
                w =
                  _.offsetWidth / 2 +
                  (_.getBoundingClientRect().x - s.getBoundingClientRect().x) *
                    u,
                v =
                  _.offsetHeight / 2 +
                  (_.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                    p,
                y = g.querySelectorAll("." + f[t].classList[3])[0],
                C =
                  y.offsetWidth / 2 +
                  (y.getBoundingClientRect().x - s.getBoundingClientRect().x) *
                    u,
                x =
                  y.offsetHeight / 2 +
                  (y.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                    p;
              ...
              n.forEach((t, a) => {
                if (0 === a && n.length - 1 == 0) {
                  ...
                  var C = t.parentElement.classList[1].replace("node_in_", ""),
                    x = (E = i.querySelector("#" + C)).querySelectorAll(
                  ...
                  (f = t),
                    (m =
                      ((x = n[a + 1]).getBoundingClientRect().x -
                        s.getBoundingClientRect().x) *
                        u +
                      r),
                    (_ =
          ...
          Object.keys(g).map(function (t, n) {
            if (null === g[t].querySelector(".point")) {
              var h = i.querySelector("#" + e),
                ...
                m = i
                  .querySelector("#" + f)
                  .querySelectorAll("." + g[t].classList[3])[0],
                _ =
                  m.offsetWidth / 2 +
                  (m.getBoundingClientRect().x - s.getBoundingClientRect().x) *
                    u,
                w =
                  m.offsetHeight / 2 +
                  (m.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                    p,
                v =
                  (h = h.querySelectorAll("." + g[t].classList[4])[0])
                    .offsetWidth /
                    2 +
                  (h.getBoundingClientRect().x - s.getBoundingClientRect().x) *
                    u,
                y =
                  h.offsetHeight / 2 +
                  (h.getBoundingClientRect().y - s.getBoundingClientRect().y) *
                    p;
              ...
              n.forEach((t, a) => {
                if (0 === a && n.length - 1 == 0) {
                  ...
                  var y = t.parentElement.classList[2].replace("node_out_", ""),
                    C = (L = i.querySelector("#" + y)).querySelectorAll(
                      "." + t.parentElement.classList[3]
                    )[0];
                  (g =
                  ...
                  (f = t),
                    (_ =
                      ((C = n[a + 1]).getBoundingClientRect().x -
                        s.getBoundingClientRect().x) *
                        u +
                      r),
                    (w =
            ...
            this.reroute_fix_curvature
              ? (d > 0
                  ? this.drawflow.drawflow[this.module].data[r].outputs[
                      i
                    ].connections[h].points.splice(d, 0, { pos_x: l, pos_y: c })
                  : this.drawflow.drawflow[this.module].data[r].outputs[
                      i
                    ].connections[h].points.push({ pos_x: l, pos_y: c }),
                e.parentElement
                  .querySelectorAll(".main-path")
                  .forEach((e, t) => {
                    e.classList.remove("selected");
        ...
        addNode(e, t, n, i, s, o, l, c, d = !1) {
          ...
          for (var g = 0; g < t; g++) {
            ...
            e.classList.add("input"),
              e.classList.add("input_" + (a)),
              (f["input_" + (a)] = { connections: [] }),
              u.appendChild(e);
          }
          const m = {};
          for (g = 0; g < n; g++) {
            ...
            e.classList.add("output"),
              e.classList.add("output_" + (a)),
              (m["output_" + (a)] = { connections: [] }),
              p.appendChild(e);
          }
                  ...
                  Object.entries(t).forEach(function (n, s) {
                    if ("object" == typeof n[1]) e(t, n[0], i + "-" + n[0]);
                      ...
                      for (
                        ...
                        (o[l].value = n[1]),
                          o[l].isContentEditable && (o[l].innerText = n[1]);
                  });
              })(null, e[0], e[0]);
            else
              for (
                var n = _.querySelectorAll("[df-" + e[0] + "]"), i = 0;
                i < n.length;
                i++
              )
                (n[i].value = e[1]),
                  n[i].isContentEditable && (n[i].innerText = e[1]);
          }),
            h.appendChild(u),
            h.appendChild(_),
            h.appendChild(p),
        ...
        addNodeImport(e, t) {
          ...
          if ((c.classList.add("drawflow_content_node"), !1 === e.typenode))
            c.innerHTML = e.html;
                  ...
                  Object.entries(n).forEach(function (e, i) {
                    if ("object" == typeof e[1]) t(n, e[0], s + "-" + e[0]);
                      ...
                      for (
                        ...
                        (o[l].value = e[1]),
                          o[l].isContentEditable && (o[l].innerText = e[1]);
                  });
              })(null, t[0], t[0]);
            else
              for (
                var i = c.querySelectorAll("[df-" + t[0] + "]"), s = 0;
                s < i.length;
                s++
              )
                (i[s].value = t[1]),
                  i[s].isContentEditable && (i[s].innerText = t[1]);
          }),
            i.appendChild(s),
            i.appendChild(c),
            i.appendChild(o),
            ...
            if (t[n].nodeName.startsWith("df-")) {
              ...
              (s[i[i.length - 1]] = e.target.value),
                e.target.isContentEditable &&
                  (s[i[i.length - 1]] = e.target.innerText),
                this.dispatch(
                  "nodeDataChanged",
                  e.target
                    .closest(".drawflow_content_node")
        ...
        updateNodeDataFromId(e, t) {
          ...
          if (
            ((this.drawflow.drawflow[n].data[e].data = t), this.module === n)
          ) {
                    ...
                    Object.entries(i).forEach(function (t, s) {
                      if ("object" == typeof t[1]) e(i, t[0], o + "-" + t[0]);
                        ...
                        for (
                          ...
                          (l[c].value = t[1]),
                            l[c].isContentEditable && (l[c].innerText = t[1]);
                    });
                })(null, e[0], e[0]);
              else
                for (
                  var s = n.querySelectorAll("[df-" + e[0] + "]"), o = 0;
                  o < s.length;
                  o++
                )
                  (s[o].value = e[1]),
                    s[o].isContentEditable && (s[o].innerText = e[1]);
            });
          }
        }
        addNodeInput(e) {
          ...
          if (
            (o.forEach((t, i) => {
              t.connections.forEach((e, t) => {
                ...
                (this.drawflow.drawflow[n].data[e].inputs["input_" + (i + 1)] =
                  t);
            }),
